...
const DoisUmFixoContext = createContext({
        Win : ()=>{},
        Loss : ()=>{},
        saldoAtual : 0,
...
export default function DoisUmFixoProvider({ children }){
...
export function useDoisUmFixo(){
    const context = useContext(DoisUmFixoContext);
    const { 
        Win,
        Loss,
        valorEntrada,
